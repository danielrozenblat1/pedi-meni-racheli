...
const AboutMe = () => {
  ...
  נכנסתי לתחום היופי עם תשוקה מטורפת ורעב להצליח.  כל מה שיכולתי ללמוד ולעשות, עשיתי. גבות, ציפורניים, מניקור, פדיקור..   <br/> רציתי יותר מהכול לבנות לעצמי עתיד, להרגיש שאני לא רק עובדת - אלא מתקדמת, צומחת, ומגשימה את עצמי באמת.
</p>
