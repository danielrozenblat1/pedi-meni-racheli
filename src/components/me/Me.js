...
const AboutMe = () => {
          ...
          <div className={`${styles.content} ${styles.revealItem}`}>
            ...
            <div className={styles.textBlock}>
              <p className={styles.paragraph}>
                כמו הרבה נשים, גם אני התחלתי מתחום היופי, מהמקום הכי בסיסי — ציפורניים, גבות, מניקור-פדיקור. רציתי להרוויח יותר, להתקדם, להרגיש שאני מגשימה את עצמי ולא רק רצה במעגלים.
              </p>
              ...
              <p className={styles.paragraph}>
                למדתי מיקרובליידינג והאמת, הקורס גם היה טוב, חלמתי להיכנס לתחום — אבל הפחדים היו גדולים ממני. פחדתי לטעות על הלקוחות שהגיעו אלי, פחדתי מהתגובות שלהן, פחדתי להיכשל — ובסוף, פשוט עזבתי את התחום. אמרתי לעצמי שזה לא בשבילי. 
              </p>
  ...
  היום אני כבר לא אותה רחלי שפחדה להתחיל. יש לי צוות מדהים של נשות מקצוע, ארבעה סניפים ברחבי הארץ, והמותג שלי הפך לשם דבר בתחום.  
  <br /><br />
  ...
  <br /><br />
   היום אני  יודעת שזו השליחות שלי: לעזור לעוד נשים כמוך, נשים שיודעות שיש להן פוטנציאל, שרוצות להפוך את התשוקה שלהן לקריירה אמיתית, מבטיחה ורווחית וכל מה שחסר להן זה הכלים המנטלים והטכניים הנכונים.
</p>
